...
public class ClassicsFooter extends InternalClassics<com.scwang.smartrefresh.layout.footer.ClassicsFooter> implements RefreshFooter {
    ...
    public ClassicsFooter(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if (REFRESH_FOOTER_NOTHING == null) {
            REFRESH_FOOTER_NOTHING = context.getString(R.string.loadfinish);
        }
        ...
        lpProgress.rightMargin = ta.getDimensionPixelSize(com.scwang.smartrefresh.layout.R.styleable.ClassicsFooter_srlDrawableMarginRight, density.dip2px(10));
...
//    }
    ...
    public boolean setNoMoreData(boolean noMoreData) {
        if (mNoMoreData != noMoreData) {
            ...
            final View arrowView = mArrowView;
            mArrowView.setImageResource(R.mipmap.icon_defaultheader_yes);
            if (noMoreData) {
