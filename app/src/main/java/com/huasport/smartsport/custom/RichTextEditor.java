...
import com.huasport.smartsport.util.BaseUtil;
...
public class RichTextEditor extends ScrollView {
    ...
    public RichTextEditor(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        allLayout.setPadding(0, 0, 0, 30);//设置间距，防止生成图片时文字太靠边，不能用margin，否则有黑边
        ...
        firstEdit = createEditText("输入正文...", dip2px(context, EDIT_PADDING));
        firstEdit.setHintTextColor(getResources().getColor(R.color.color_999999));
        firstEdit.setTextColor(getResources().getColor(R.color.color_333333));
        firstEdit.setTextSize(15);
...
//        }
    ...
    public EditText createEditText(String hint, int paddingTop) {
        ...
        editText.setLineSpacing(BaseUtil.getInstance().dip2px(6), 1);
        try //修改光标的颜色（反射）
        {
     ...
     */
    public void addEditTextAtIndex(final int index, CharSequence editStr,String hint) {

        EditText editText2 = createEditText(hint, EDIT_PADDING);
    ...
    public void removeViews() {
        if (!EmptyUtil.isEmpty(allLayout)) {
            allLayout.removeViewAt(0);
        }
    }
