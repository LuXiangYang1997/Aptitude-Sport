...
public class LocationUtils {
    ...
    private ILocationCallBack mLocationBack;

    public LocationUtils(Context context, ILocationCallBack callback) {
        mContext = context;
        this.mLocationBack = callback;
//        getLocation();
    }
    //采用Double CheckLock(DCL)实现单例


    public void setGetDataListener(ILocationCallBack callBack){
        this.mLocationBack = callBack;
    }
    ...
    public void getLocation() {
        ...
        if (providers.contains(LocationManager.NETWORK_PROVIDER)) {
            ...
            //如果是GPS定位       LogBean.d( TAG, "如果是GPS定位" );
    ...
    private void setLocation(Location location) {
        mLocationBack.getLocation(location);
