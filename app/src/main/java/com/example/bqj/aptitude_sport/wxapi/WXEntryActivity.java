...
import com.example.bqj.aptitude_sport.bean.WXLoginBean;
...
//        mWaitDialog.show();
        ...
        OkHttpUtil.getThirdInfo(this, path, new RequestCallBack<Object>() {
            @Override
            ...
            @Override
            public Object parseNetworkResponse(String jsonResult) {
